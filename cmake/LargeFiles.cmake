...
macro(use_large_files TARGET USE_64_SUFFIX)
    ...
    if(USING_LARGE_FILES)
        if(DEFINED _FILE_OFFSET_BITS)
            target_compile_definitions(${TARGET} PRIVATE _FILE_OFFSET_BITS=${_FILE_OFFSET_BITS})
        endif(DEFINED _FILE_OFFSET_BITS)

        if(DEFINED _LARGEFILE_SOURCE)
            target_compile_definitions(${TARGET} PRIVATE _LARGEFILE_SOURCE)
        ...
        message(WARNING "Large file support not available (can't open files >2GB)")
